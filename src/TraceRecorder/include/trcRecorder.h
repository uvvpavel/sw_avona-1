 ...
 ******************************************************************************/
    ...
    **************************************************************************/
	...
	do { _ptrData = (_type*)prvPagedEventBufferGetWritePointer(_size); } while (_ptrData == NULL);
		...
		#define TRC_STREAM_PORT_ALLOCATE_EVENT(_type, _ptrData, _size) _type *_ptrData = (_type*)&xEventDataDummy[TRC_GET_CURRENT_CORE()];
		#define TRC_STREAM_PORT_ALLOCATE_EVENT_BLOCKING(_type, _ptrData, _size) _type *_ptrData = (_type*)&xEventDataDummy[TRC_GET_CURRENT_CORE()];
	#else
